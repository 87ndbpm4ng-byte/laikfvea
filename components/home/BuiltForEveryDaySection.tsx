        ...
        <div>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            {content.cards.map((card) => (
              <article
                key={card.title}
                className="rounded-brand bg-white p-7 shadow-[0_20px_60px_rgba(28,28,28,0.055)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_80px_rgba(28,28,28,0.075)]"
              >
